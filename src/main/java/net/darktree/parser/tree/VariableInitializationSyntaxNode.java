...
public class VariableInitializationSyntaxNode extends AbstractSyntaxNode {
	...
	public VariableInitializationSyntaxNode(Token access, String type, int pointer, String name) {
		this.access = access;
		this.type = type;
